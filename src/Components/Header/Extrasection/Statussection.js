        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-4 '>
            <div className='flex space-x-5  justify-center w-full'>
                ...
                <div>
                    ...
                    <p className='text-xl uppercase font-semibold'>Packages Delivered</p>
                </div>
            </div>
            <div className='flex space-x-5  justify-center w-full'>
                ...
                <div>
                    ...
                    <p className='text-xl uppercase font-semibold'>Repeat Customer</p>
                </div>
            </div>
            <div className='flex space-x-5  justify-center w-full'>
                ...
                <div>
                    ...
                    <p className='text-xl uppercase font-semibold'>Our Happy Clients</p>
                </div>
            </div>
            <div className='flex justify-center w-full'>
                ...
                <div>
                    ...
                    <p className='text-xl uppercase font-semibold'>Commercial Goods</p>
                </div>
            </div>
        </div>
    );
